...
public class City extends Geometry {
	...
	protected Point2D.Float remotePoint;

	protected boolean isTerminal = false;
	protected String terminalAirportName;
	...
	public City(final String name, final int x, final int y, final int radius,
			final String color, final int remoteX, final int remoteY) {
		this.name = name;
		pt = new Point2D.Float(x, y);
		this.radius = radius;
		this.color = color;
		this.remotePoint = new Point2D.Float(remoteX,remoteY);
	}
	...
	public City(final String terminalAirportName, final String toCityName, 
			final String name, final int x, final int y, final int remoteX, final int remoteY) {
		this.name = name;
		pt = new Point2D.Float(x, y);
		this.remotePoint = new Point2D.Float(remoteX,remoteY);
		this.isTerminal = true;
		this.terminalAirportName = terminalAirportName;
	...
	public String getColor() {
		if(isTerminal) return "isTerminal"; else{return color;}
	}
	...
	public boolean equals(final Object obj) {
		...
		if (obj != null && (obj.getClass().equals(this.getClass()))) {
			...
			if(isTerminal) {
				return pt.equals(c.pt) && remotePoint.equals(c.remotePoint);
			}
			else {
	...
	public String getTerminalAirportName() {
		return terminalAirportName;
	}
