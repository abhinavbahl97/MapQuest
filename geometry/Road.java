...
public class Road extends Geometry {
	...
	public boolean containsAirportName(String airportName) {
		if(start.isTerminal){
			return start.terminalAirportName.equals(airportName);
		}

		if(end.isTerminal) {
			return end.terminalAirportName.equals(airportName);
		}
		return false;
	}
