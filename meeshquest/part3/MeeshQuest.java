...
import cmsc420.pmquadtree.IndexOutOfBoundException;
...
public class MeeshQuest {
    ...
    public static void main(String[] args) {
		...
		if (LOCAL_TEST) {
			File[] files = new File("/Users/abhinavbahl/Documents/workspace/CMSC420/CanImplementation/src/testfiles/").listFiles();
    ...
    public void processInput() {
        ...
        try {
			...
			if (LOCAL_TEST) {
				...
				xmlInput = new File("/Users/abhinavbahl/Documents/workspace/CMSC420/CanImplementation/src/testfiles/" + testName + ".input.xml");
			}
			...
			if (LOCAL_TEST) {
				try {
					xmlOutput = new File("/Users/abhinavbahl/Documents/workspace"
							+ "/CMSC420/CanImplementation/src/testfiles/" + testName + ".output.xml");
					XmlUtility.write(results, xmlOutput);
			//		XmlUtility.write(results, System.out);
				} catch (Exception e) {
					e.printStackTrace();
				}
			} else {
